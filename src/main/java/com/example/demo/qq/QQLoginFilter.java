...
/**
 * 拦截 /QQLogin请求，用于引导用户到QQ的认证服务器，获取授权码(code)，获取访问令牌(access_token)
 *
 * @描述
 * @作者 huan
...
public class QQLoginFilter extends AbstractAuthenticationProcessingFilter {
     ...
     */
    private static final String CLIENT_ID = "101513767";

    /**
     * client_secret 即在QQ互联上创建应用的APP Key
     */
    private static final String CLIENT_SECRET = "b1d978cefcf405388893d8e686d307b0";

    /**
     * redirect_uri 即在QQ互联上创建应用的回调地址
     */
    private static final String REDIRECT_URI = "http://127.0.0.1:8080/QQLogin";
